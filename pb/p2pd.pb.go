...
type CallUnaryRequest struct {
	Peer                 []byte   `protobuf:"bytes,1,req,name=peer" json:"peer,omitempty"`
	Protos               []string `protobuf:"bytes,2,rep,name=protos" json:"protos,omitempty"`
...
func (m *CallUnaryRequest) GetProtos() []string {
	if m != nil {
		return m.Protos
	}
	return nil
...
func (m *SendResponseToRemote) GetError() []byte {
	if m != nil {
		return m.Error
	}
	return nil
...
type RequestHandling struct {
	CallId               *int64   `protobuf:"varint,1,req,name=callId" json:"callId,omitempty"`
	Data                 []byte   `protobuf:"bytes,2,req,name=data" json:"data,omitempty"`
	Protos               []string `protobuf:"bytes,3,rep,name=protos" json:"protos,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *RequestHandling) GetProtos() []string {
	if m != nil {
		return m.Protos
	}
	return nil
...
var fileDescriptor_7333f0e9b622f7df = []byte{
	...
	,
}
...
func (m *CallUnaryRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Protos) > 0 {
		for iNdEx := len(m.Protos) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.Protos[iNdEx])
			copy(dAtA[i:], m.Protos[iNdEx])
			i = encodeVarintP2Pd(dAtA, i, uint64(len(m.Protos[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *CallUnaryRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Protos = append(m.Protos, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Data", wireType)
